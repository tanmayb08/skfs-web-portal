                ...
                <div className="hidden lg:block flex-1 max-w-md mx-4 xl:mx-8">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-4 pr-10 py-2 border-2 border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden bg-white border-t border-gray-100 absolute top-[130px] left-0 right-0 z-50 shadow-lg">
                    <nav className="flex flex-col p-4 space-y-4">
                                        ...
                                        return (
                                            <div key={category.id}>
                                                <button
                                                    ...
                                                    className="flex items-center justify-between w-full text-gray-900 hover:text-orange-500 py-1"
                                                >
                                                ...
                                                {isOpen && (
                                                    <div className="pl-4 mt-2 flex flex-col space-y-2 border-l-2 border-gray-100">
                                                        ...
                                                        <Link
                                                            ...
                                                            className="text-sm text-gray-900 hover:text-orange-500 font-medium"
                                                            onClick={() => setIsMobileMenuOpen(false)}
                                                        >
                                                            View All
                                                        </Link>
                        ...
                        <Link href="/contact-us" className="text-lg font-medium text-gray-900" onClick={() => setIsMobileMenuOpen(false)}>Contact</Link>
                        <Link href="/contact-us" onClick={() => setIsMobileMenuOpen(false)}>
                            <button className="w-full bg-orange-500 text-white px-6 py-2 rounded-[14px] font-medium hover:bg-orange-600 transition-colors">
                                Request Quote
                            </button>
                        </Link>
                    </nav>
